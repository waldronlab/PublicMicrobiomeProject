...
try:
    ...
    #https://bioconductor.org/packages/release/bioc/html/bugsigdbr.html
        ...
        projects.append({
            ...
            "Repository":  f'<a href="{item["html_url"]}" target="_blank">{item["name"]} <img src="/bd4everyone/PublicMicrobiomeProject/githubicon.svg" alt="GitHub Icon" style="height: 0.9em; vertical-align: middle; margin-left: 10px;"> </a>',
